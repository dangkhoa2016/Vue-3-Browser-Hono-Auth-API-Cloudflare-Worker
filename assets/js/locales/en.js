export default {
  message: {
    ...
    realtime_monitoring: {
      ...
      refresh_events: 'Recent Events',
      test_alerts: 'Test Alerts',
      clear_cache: 'Clear Cache',
      create_incident: 'Create Incident',
      access_denied_title: 'Access denied',
      access_denied_message: 'Only admin and super admin can access this page.',
      timeline_total_failures: 'Total Failures',
      timeline_avg_per_hour: 'Avg / Hour',
      recent_events_title: 'Recent Events',
      recent_events_subtitle: 'Latest activity stream exposed by the monitoring service.',
      recent_events_count: '{count} events',
      event_label: 'Event',
      ...
      ops_controls_title: 'Ops Controls',
      ops_controls_subtitle: 'Quick actions for alerting and dashboard maintenance.',
      create_rule: 'Create Rule',
      create_channel: 'Create Channel',
      create_rule_default_prefix: 'Custom rule',
      create_channel_default_prefix: 'Channel',
      avg_response: 'Avg Response',
      cache_hit: 'Cache Hit',
      health: 'Health',
      health_unknown: 'unknown',
      latest_incident: 'Latest Incident',
      no_latest_incident: 'No manual incident created in this session.',
      alert_rules_title: 'Alert Rules',
      alert_rules_subtitle: 'Rule engine status and per-rule toggle controls.',
      enabled_summary: '{enabled} / {total} enabled',
      rule_label: 'Rule',
      triggers_label: 'Triggers',
      no_description: 'No description',
      enabled: 'Enabled',
      disabled: 'Disabled',
      no_alert_rules: 'No alert rules.',
      alert_channels_title: 'Alert Channels',
      alert_channels_subtitle: 'Delivery channels configured on the monitoring backend.',
      channel_fallback: 'channel',
      sent_label: 'Sent',
      last_used_label: 'Last Used',
      no_alert_channels: 'No alert channels.',
      prompt_rule_name: 'Rule name',
      prompt_rule_description: 'Rule description',
      prompt_rule_description_default: 'Created from realtime monitoring UI',
      prompt_severity: 'Severity (low, medium, high, critical)',
      prompt_condition_pattern: 'Condition pattern',
      prompt_channel_name: 'Channel name',
      prompt_channel_type: 'Channel type (email, webhook, slack)',
      prompt_channel_target: 'Channel target',
      cooldown_label: 'Cooldown (seconds)',
      rule_name_required: 'Rule name is required.',
      rule_channels_required: 'Select at least one alert channel.',
      ...
      prompt_cache_key: 'Cache key to clear. Leave blank to clear all.',
      all_dashboard_cache: 'all dashboard cache',
      confirm_clear_cache: 'Clear {label}?',
      clear_cache_failed: 'Failed to clear cache.',
      prompt_incident_description: 'Incident description',
      prompt_incident_description_default: 'Manual incident created from monitoring UI',
      prompt_incident_severity: 'Incident severity (low, medium, high, critical)',
      prompt_incident_type: 'Incident type',
      incident_description_required: 'Incident description is required.',
      create_incident_failed: 'Failed to create incident.',
      disable_rule_confirm_title: 'Disable rule?',
      disable_rule_confirm_message: 'This will stop the selected rule from triggering alerts until you enable it again.',
      disable_rule_action: 'Disable Rule',
      enable_rule_confirm_title: 'Enable rule?',
      enable_rule_confirm_message: 'This will allow the selected rule to trigger alerts again.',
      enable_rule_action: 'Enable Rule'
    },
    system_health: {
    ...
    settings: {
      ...
      subtitle: 'Manage local browser defaults and application preferences that directly affect admin workflows in this browser.',
      tabs: {
        account: 'Account',
        workspace: 'Workspace',
        system: 'System'
      ...
      login_required_message: 'Please login with an admin or super admin account to access settings.',
      public_badge: 'Public access',
      public_title: 'Update the API endpoint before signing in',
      public_message: 'This public mode keeps only the API endpoint editable so you can point the app at the correct backend first. Sign in and come back to unlock the rest of the settings.',
      public_login_action: 'Login to see more settings',
      public_system_title: 'Connection Setup',
      public_endpoint_saved: 'API endpoint updated. You can sign in later to access the rest of the settings.',
      access_denied_title: 'Access denied',
      access_denied_message: 'This page is reserved for admin and super admin accounts.',
      last_synced: 'Last synced',
      never_synced: 'Not synced yet',
      account_badge: 'Account',
      account_title: 'Account Settings',
      account_subtitle: 'This section uses the existing profile update and password change endpoints already provided by the backend.',
      security_title: 'Password and Security',
      security_subtitle: 'Uses the current authenticated session password change endpoint.',
      workspace_badge: 'Workspace',
      workspace_title: 'Browser Preferences',
      workspace_subtitle: 'These preferences apply to the current browser and follow the locales or modes already supported by the app and API.',
      language_label: 'Language',
      language_hint: 'Server-advertised locales currently available',
      theme_label: 'Theme',
      theme_light: 'Light',
      theme_light_hint: 'Bright surfaces and higher daylight contrast',
      theme_dark: 'Dark',
      theme_dark_hint: 'Lower-glare palette for dense admin workflows',
      api_mode_label: 'API Mode',
      api_mode_mock_hint: 'Use bundled fixtures for safe UI exploration',
      api_mode_real_hint: 'Send requests to the configured backend API',
      scope_note_title: 'Scope',
      scope_note_body: 'Theme, locale, API mode, endpoint, admin page size, search debounce, request timeout, and time format are browser-local preferences.',
      system_badge: 'System',
      system_title: 'Application Preferences',
      system_subtitle: 'These settings are stored in this browser and immediately affect future admin requests and list views.',
      api_endpoint_label: 'Server Endpoint',
      api_endpoint_hint: 'Used when API mode is REAL. Changes apply to new requests after saving.',
      page_size_label: 'Default Admin Page Size',
      page_size_hint: 'Used as the initial limit for paginated admin tables.',
      request_timeout_label: 'Request Timeout (ms)',
      request_timeout_hint: 'Applied to future API requests from this browser. Useful when switching between local, preview, and remote environments.',
      search_debounce_label: 'Admin Search Debounce (ms)',
      search_debounce_hint: 'Used by admin search boxes before firing server-side filtering again.',
      time_format_label: 'Time Format',
      time_format_hint: 'Applied to admin timestamps across dashboard, incident, user, audit, and KV admin screens.',
      time_format_locale: 'Locale default',
      time_format_12h: '12-hour clock',
      time_format_24h: '24-hour clock',
      current_values_title: 'Current runtime values',
      current_endpoint: 'Active endpoint',
      current_page_size: 'Default page size',
      current_api_mode: 'API mode',
      current_request_timeout: 'Request timeout',
      current_search_debounce: 'Search debounce',
      current_time_format: 'Time format',
      api_endpoint_reset_action: 'Reset Endpoint',
      page_size_reset_action: 'Use 20 Rows',
      request_timeout_reset_action: 'Use 15000 ms',
      search_debounce_reset_action: 'Use 300 ms',
      time_format_reset_action: 'Use locale time',
      system_summary_badge: 'Runtime Summary',
      system_summary_title: 'What changes here',
      system_summary_subtitle: 'These preferences stay local to the browser storage layer used by the app.',
      system_scope_title: 'Local scope and effect',
      system_scope_body: 'Changing the endpoint affects future REAL API requests. Page size changes alter the default row count for admin lists. Search debounce adjusts how quickly admin filters hit the server again, and time format updates how timestamps are rendered across the admin UI.',
      system_cards: {
        endpoint: 'API endpoint',
        page_size: 'Default page size',
        request_timeout: 'Request timeout',
        api_mode_scope: 'Applies to',
        real_requests: 'Real requests',
        mock_requests: 'Mock mode is active',
        search_debounce: 'Search debounce',
        time_format: 'Time format'
      },
      super_admin_badge: 'Super Admin',
      super_admin_note_title: 'System controls are role-gated',
      super_admin_note_body: 'The current backend only exposes audit feature toggles and realtime alert configuration to super-admin accounts, so the page keeps those controls hidden unless the authenticated role can actually use them.',
      features_title: 'Audit Feature Flags',
      features_subtitle: 'These toggles use the KV audit feature endpoints currently provided by the backend.',
      alerts_badge: 'Realtime Alerts',
      alerts_title: 'Alert Configuration JSON',
      alerts_subtitle: 'This editor stays generic on purpose, because the server accepts thresholds/settings objects and may evolve independently.',
      thresholds_json: 'Thresholds JSON',
      settings_json: 'Settings JSON',
      snapshot_badge: 'Server Snapshot',
      snapshots_title: 'Read-only Runtime Snapshots',
      snapshots_subtitle: 'Quick visibility into other audit-related settings already exposed by the backend.',
      profile_load_failed: 'Failed to load profile',
      system_load_failed: 'Failed to load system settings',
      profile_save_failed: 'Failed to save profile',
      language_updated: 'Language updated for this browser session.',
      theme_updated: 'Theme updated.',
      api_mode_updated: 'API mode updated.',
      api_endpoint_invalid: 'API endpoint must be a valid HTTP or HTTPS origin.',
      page_size_invalid: 'Page size must be at least 1.',
      request_timeout_invalid: 'Request timeout must be at least 1000 ms.',
      time_format_invalid: 'Choose a supported time format.',
      no_changes_to_save: 'No changes to save.',
      system_preferences_saved: 'System preferences updated.',
      system_preferences_save_failed: 'Failed to update system preferences.',
      api_endpoint_reset: 'API endpoint reset to default.',
      feature_toggle_failed: 'Failed to update feature flag.',
      feature_toggle_success: 'Feature flag updated.',
      alerts_saved: 'Alert configuration updated.',
      alerts_save_failed: 'Failed to save alert configuration.',
      invalid_json: 'Invalid JSON payload. Please fix the syntax and try again.',
      copy_link: 'Copy link',
